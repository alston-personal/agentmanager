...
class VopcGeminiOneDeployContractTests(unittest.TestCase):
    ...
    def test_workflow_uses_typed_bootstrap_not_runner_user_systemd(self):
        ...
        self.assertIn("windows_antigravity_bounded_deploy=BEGIN", client)
        self.assertIn("windows_antigravity_bounded_deploy=END", client)
        ...
        self.assertNotIn("Get-CimInstance Win32_Process", client)
        self.assertNotIn("Get-ChildItem -Path $geminiRoot -Recurse", client)
