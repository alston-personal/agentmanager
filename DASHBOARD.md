...
| ☁️ | **AI_Command_Center** | [STATUS](./projects/AI_Command_Center/STATUS.md) | 🟢 Active Development (Migrate Workflow Ready) |
...
## ⚙️ 系統服務 (Infrastructure & Services)

| 服務名稱 | 角色定位 | 目前路徑 | 狀態 |
| :--- | :--- | :--- | :--- |
| **n8n Automation** | 核心自動化調度器 (The Hands) | [/home/ubuntu/n8n-automation](./projects/n8n-live) | 🟢 Running |
...
| 專案發想 | 目標描述 | 階段 |
| :--- | :--- | :--- |
| **AI Center Expansion** | 系統性整合 N8n 模組、VLM 決策引擎與硬體接口 | [分析中](./ideas/AI_Center_Expansion/INTEGRATION_PLAN.md) |
| **Citizen Watch** | IVOD 影片語意索引與族譜系統 | 待分析 |
| **Trading Evolver** | 量化交易策略自動迭代器 | 待分析 |
| **Stock Autopilot** | AI 圖庫自動生成與營收系統 | 待分析 |
