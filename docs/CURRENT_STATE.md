...
| Historical IR lineage / reconciliation | Implemented + tested, not automatically hydrated | `agent_core/historical_ir.py`, `agentos_node/conversation_backfill.py` | `tests/test_historical_ir.py`, `tests/test_conversation_backfill.py` |
| Post-join executor Experience recovery planning | Implemented + tested; automatic promotion remains governed | `agentos_node/executor_experience_recovery.py`, `agentos_node/client_cli.py` | `tests/test_executor_experience_recovery.py` |
