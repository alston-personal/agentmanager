...
if action in text:
    print('layoutlib_action_patch=ALREADY_PRESENT')
    raise SystemExit(0)
...
mapping_anchor = '    "github.repo.ensure_arcanaforge": _ensure_arcanaforge_remote,\n'
...
text = text.replace(mapping_anchor, mapping_anchor + '    "github.repo.ensure_layoutlib": _ensure_layoutlib_remote,\n', 1)

compile(text, str(path), 'exec')
path.write_text(text, encoding='utf-8')
print('layoutlib_action_patch=PASS')
